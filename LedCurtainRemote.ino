...
*  with my smart home using MQTT. This code is dedicating to detecting the 
*  power signal and sends MQTT commands to the IR blaster.    -Manny Batt
* 
* 
...
void loop() {
  ...
  if (powerState == 1 && prevPowerState == 0) {
    ...
    switch (choice) {
      case 1: irsend.sendNEC(16187647, 64); //red
        break;
      case 2: irsend.sendNEC(16220287, 64); //green
        break;
      case 3: irsend.sendNEC(16203967, 64); //blue
        break;
      case 4: irsend.sendNEC(16212127, 64); //purple
        break;
      case 5: irsend.sendNEC(16199887, 64); //cyan
        break;
    }
  }
...
void wifiSetup() {
  ...
  ArduinoOTA.setHostname("LedCurtains-Remote");
  ArduinoOTA.onStart([]() {
    String type;
